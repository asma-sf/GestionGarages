...
public class GarageServiceImpl implements GarageService {
	...
	public GarageServiceImpl(GarageRepository garageRepository, VehiculeRepository vehiculeRepository) {
	...
	public List<Garage> searchGaragesByVehiculeType(String vehiculeType) {
		...
		try {
			TypeVehicule type = TypeVehicule.valueOf(vehiculeType.toUpperCase());
			
			List<Vehicule> vehicules = vehiculeRepository.findByTypeVehicule(type);

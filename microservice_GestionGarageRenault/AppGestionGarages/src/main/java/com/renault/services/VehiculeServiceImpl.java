...
public class VehiculeServiceImpl implements VehiculeService {
	...
	public VehiculeServiceImpl(VehiculeRepository vehiculeRepository, GarageRepository garageRepository) {
	...
	public Vehicule addVehiculeToGarage(Long garageId, Vehicule vehicule) {
		...
		if (vehicule.getTypeVehicule() != null) {
			vehicule.setTypeVehicule(TypeVehicule.valueOf(vehicule.getTypeVehicule().name().toUpperCase()));
		}
	...
	public Vehicule updateVehicule(Long vehiculeId, Vehicule vehicule) {
		...
		if (vehicule.getTypeVehicule() != null) {
			vehiculeToUpdate.setTypeVehicule(vehicule.getTypeVehicule());
		}
